...
<?php
  ...
  // Start the session
  session_start();
  if(!isset($_POST['addAlbumSubmit']) && !isset($_POST['addSongSubmit']) && !isset($_POST['dedicationSubmit']) && !isset($_POST['editAlbumSubmit']) && !isset($_POST['addBlogPostSubmit']) && isset($_SESSION['loggedIn']))
   {
                 ...
                 if(isset($_SESSION['loggedIn']))
                 {
                          ...
                          echo '<div class="container">
                                    ...
                                    <ul class="nav nav-tabs">
                                      ...
                                      <li><a data-toggle="tab" href="#menu3">Blog Post</a></li>
