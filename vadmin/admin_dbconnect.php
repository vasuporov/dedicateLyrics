...
/***********************************************for blog posts ********************************************/
 ...
 $blogMiniAttribute = "`id`, `title`, `one_liner`, `date_added`, `added_by`, `category`, `profile_image`,  `url`";
 $blogtable     = "blog_post";
  ...
  global $mysqli;
    ...
    $url = str_replace('"',"",$url);
     $url = str_replace('!',"",$url);
      ...
      $query = "INSERT INTO `".$database."`.`".$blogtable."` (".$blogAttribute.") VALUES (NULL, '".mysqli_real_escape_string($mysqli, $title)."', '".mysqli_real_escape_string($mysqli, $oneLiner)."', CURRENT_TIMESTAMP, '".mysqli_real_escape_string($mysqli, $addedBy)."', '".mysqli_real_escape_string($mysqli, $category)."', '0', '".mysqli_real_escape_string($mysqli, $coverImageLocation)."', '".mysqli_real_escape_string($mysqli, $profileImageLocation)."', '".mysqli_real_escape_string($mysqli, $description)."', '".mysqli_real_escape_string($mysqli, $url)."', '".mysqli_real_escape_string($mysqli, $tags)."', '".mysqli_real_escape_string($mysqli, $putOnCarousel)."')";
      //echo $query;
...
function verifyTitle($title)
{
  ...
  $query = "SELECT ".$blogMiniAttribute." FROM `".$database."`.`".$blogtable."` WHERE `title` = '".$title."' ";
  $result = $mysqli->query($query);
...
/*function getBlogsUnqiueUrl($title)
{
  global $database;
  global $blogtable;
  global $blogAttribute
  ...
  $url = str_replace(" ","-",$title);
  $query = "SELECT ".$blogMiniAttribute." FROM `".$database."`.`".$blogtable."` WHERE `url` = ".$url." ";
