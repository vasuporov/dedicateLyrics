...
<div class="theme" style="background-image: url('<?php global $themeForMiniHeader; echo $themeForMiniHeader;?>');background-position: left center; background-repeat: no-repeat; width:100%;border="0"; background-size: cover;">
