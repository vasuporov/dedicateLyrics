...
<meta property="og:description" content="Here you can find the lyrics for the latest bollywood songs of all ages and genre.
Dedicatelyrics.com provides/offers you a wonderful experience which none other can!! You can associate songs to people and make them realize how much you love them,
 with all your intense feelings with the lyrics of bollywood hindi songs. " />
...
<!-- header -->
	...
	<div class="container">
		<div class="logo wow fadeInLeft" data-wow-delay="0.5s">
			<a href="<?php echo $mainUrl;?>"><img src="<?php echo $mainUrl;?>images/mainlogo.png"/><img src="<?php echo $mainUrl;?>images/logo.png" alt=" " /></a>
		</div>
...
<div class="sitebackground"> <!--100% width for background color of site end just before footer-->
         ...
         <h1><center>  <span class="   indigo lighten-5 white-text" style="font-family: 'Oswald', sans-serif;
        font-size: 40px;
        line-height:2em;
        background:none;">&nbsp;&nbsp; DEDICATION WALL OF THE WEEK &nbsp;&nbsp;</span>   </center></h1>
                    ...
                    <?php
                      ...
                      $result = getDedicationsOfWeek($page);
                        ...
                        if((!$result) || mysqli_num_rows($result)==0)
                           {
                             echo '<center><br><br><br><br><br><br>None yet! Be the first one to dedicate.</center>';
                           }
                        else 
                        {
