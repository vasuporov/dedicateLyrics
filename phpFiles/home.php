<meta name="propeller" content="b4e9650b9b8c3526da01c0c90632804d" />
	  ...
	  <h1>TOP DEDICATIONS OF WEEK</h1>
		   <div class="bottom">
                        ...
                        <div id="loader">
                                        ...
                                        <br><br><br><br>
                                       <img src="<?php echo $mainUrl;?>images/musicalloader.gif" alt="Loading dedications"/><br>
                                       Loading...
                                       <br><br> <br><br>
...
<?php
		...
		<div class="bottom">
                          ...
                          while($album = $latestAlbums->fetch_assoc())
                           {
                             ...
                             <div class="album-grid  col-md-2 col-xs-5 col-sm-3 wow fadeInUp" style="margin-left:10px; margin-top:5px;" data-wow-delay="0.5s">
				...
				<img src="'.$mainUrl.$album['AlbumImage'].'" alt="hindi lyrics from the movie '.$album['AlbumName'].'" />
				 </a>
			       </div>
